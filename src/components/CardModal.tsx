            ...
            {effectiveLe && showArt ? (
              ...
              <>
                ...
                {openingState === "revealed" && showArt && (
                  <div className="animate-card-reveal relative z-10 aspect-card w-[min(78vw,315px)] overflow-hidden rounded-md border border-white/10 shadow-2xl sm:w-[330px] md:w-[350px]">
                    {regularImg ? (
                      <Image
                        src={regularImg}
                        alt={card.title || publicLabel(card)}
